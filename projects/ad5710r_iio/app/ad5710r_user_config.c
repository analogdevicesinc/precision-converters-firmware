/*************************************************************************//**
 *   @file   ad5710r_user_config.c
 *   @brief  User configuration file for AD5710R
******************************************************************************
...
struct ad5710r_init_param ad5710r_init_params = {
	.chip_id = AD5710R_ID,
	...
	.vref_enable = AD5710R_EXTERNAL_VREF_PIN_INPUT,
	.chn_op_mode = {
		AD5710R_CH_OPERATING_MODE_3, AD5710R_CH_OPERATING_MODE_3,
		AD5710R_CH_OPERATING_MODE_3, AD5710R_CH_OPERATING_MODE_3,
		AD5710R_CH_OPERATING_MODE_3, AD5710R_CH_OPERATING_MODE_3,
		AD5710R_CH_OPERATING_MODE_3, AD5710R_CH_OPERATING_MODE_3
	},
	.range = AD5710R_CH_OUTPUT_RANGE_0_VREF,
	.hw_ldac_mask = 0xff,
	.sw_ldac_mask = 0xff,
	/* Set to enable CRC */
	.crc_en = false,
