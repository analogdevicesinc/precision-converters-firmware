...
import csv
import math
#from adi import ad4696         # TODO - Add later
...
def init_data_capture():
    ...
    uri = "serial:COM9,230400"  # For UART, baud rate must be same as set in the FW. COM port is physical Or VCOM.
    device_name = "ad4696"      # Name of the device must be same as set in the FW.
    ######################################

    # Create an IIO device context
    device = ad4696(uri, device_name)
