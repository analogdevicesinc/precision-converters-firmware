...
struct mbed_gpio_init_param mbed_reset_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_convst_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_busy_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_osr0_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_osr1_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_osr2_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_range_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

struct mbed_gpio_init_param mbed_stdby_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};
