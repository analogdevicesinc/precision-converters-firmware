...
import csv
import math
#from adi import ad7606         # TODO - Add later
...
def init_data_capture():
    ...
    device_name = "ad7606b"      # Name of the device must be same as set in the FW.
    ######################################

    # Create an IIO device context
    device = ad7606(uri, device_name)
    ...
    # size of ADC sample
    if (device_name == "ad7606c-18" or device_name == "ad7608" or device_name == "ad7609"):
        device._rx_data_type = np.uint32
    else:
