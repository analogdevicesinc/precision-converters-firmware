...
#define	AD4170_THERMISTOR_CONFIG_OFFSET_RESET_VAL		0x0
#define AD4170_THERMISTOR_CONFIG_GAIN_RESET_VAL			0x555555
...
struct ad4170_init_param ad4170_thermistor_config_params = {
	...
	.config = {
		...
		.map = {
			...
			{ . ainp = AD4170_AIN5, .ainm = AD4170_AIN6 },	// Chn2
		...
		.setups = {
			// Setup 0
			{
				...
				.offset = AD4170_THERMISTOR_CONFIG_OFFSET_RESET_VAL,
				.gain = AD4170_THERMISTOR_CONFIG_GAIN_RESET_VAL,
			},
			// Setup 1
			{
				.misc = {
