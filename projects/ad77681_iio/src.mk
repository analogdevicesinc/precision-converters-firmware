...
#SOURCE_DIRS += $(LIBRARIES_PATH)/no-OS/drivers/adc/ad7768-1 // TODO - uncomment when no-os driver bug is fixed
...
#SOURCE_INCLUDE_PATHS += $(LIBRARIES_PATH)/no-OS/drivers/adc/ad7768-1 // TODO - uncomment when no-os driver bug is fixed
