...
SOURCE_DIRS += $(LIBRARIES_PATH)/no-OS/drivers/temperature/adt7420
...
SOURCE_DIRS += $(LIBRARIES_PATH)/precision-converters-library/tempsensors
...
SOURCE_INCLUDE_PATHS += $(LIBRARIES_PATH)/no-OS/drivers/temperature/adt7420
...
SOURCE_INCLUDE_PATHS += $(LIBRARIES_PATH)/no-OS/iio
...
SOURCE_INCLUDE_PATHS += $(LIBRARIES_PATH)/precision-converters-library/tempsensors
