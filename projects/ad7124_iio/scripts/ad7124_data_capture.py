...
def init_data_capture():
    ...
    uri = "serial:COM32,230400"   # For UART, baud rate must be same as set in the FW. COM port is physical Or VCOM.
    device_index = 0     # Device Index.
    ######################################

    # Create an IIO device context
    device = ad7124(uri, device_index)
