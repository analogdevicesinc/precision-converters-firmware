 ...
 * @brief   Source file for the mbed configuration for nanodac Console Application
********************************************************************************
...
/* Reset Pin Mbed Platform specific parameters */
struct mbed_gpio_init_param reset_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

/* LDAC Pin Mbed Platform specific parameters */
struct mbed_gpio_init_param ldac_gpio_extra_init_params = {
	.pin_mode = 0	// NA
};

/* Gain Pin Mbed Platform specific parameters */
